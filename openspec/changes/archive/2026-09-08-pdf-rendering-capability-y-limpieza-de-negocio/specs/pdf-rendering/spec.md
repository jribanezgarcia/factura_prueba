...
> Los seis requisitos que siguen no son nuevos: se **mueven** desde la capability
> `invoicing`, con su texto intacto salvo donde se indica. El unico requisito
> escrito de cero es el ultimo, «Separacion de responsabilidades en la exportacion».
