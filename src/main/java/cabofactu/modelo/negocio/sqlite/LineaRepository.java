...
public class LineaRepository {
    ...
    public void insertarLineas(long versionId, List<LineaFactura> lineas) {
        try {
            String sql = """
    ...
    public void eliminarPorVersion(long versionId) {
        try {
    ...
    public List<LineaFactura> getLineas(long versionId) {
        try {
