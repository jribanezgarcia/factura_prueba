...
public final class BarraNavegacion {
    ...
    private static final String RUTA_BACKUP = "/cabofactu/vista/recursos/Backup.fxml";
    ...
    public static HBox crear(Navegador nav, String actual) {
        ...
        barra.getChildren().addAll(
                ...
                boton("Copias", "Copia de seguridad", ICONO_BACKUP, 1.25, () -> nav.mostrar(RUTA_BACKUP), "backup".equals(actual)),
